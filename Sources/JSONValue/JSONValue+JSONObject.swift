...
extension JSONValue {
    ...
    static func matchJSONValueOrNull(_ value: Any) -> JSONValue? {
        if value is NSNull {
            return .null
        }
    ...
    static func matchIntegerJSONObject(_ value: Any) throws -> JSONValue? {
    ...
    static func matchUnsignedIntegerJSONObject(_ value: Any) throws -> JSONValue? {
    ...
    static func matchFloatingPointJSONObject(_ value: Any) -> JSONValue? {
    ...
    static func matchContainerJSONObject(_ value: Any) throws -> JSONValue? {
